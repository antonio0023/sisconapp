...
public class EstadoDeCapital extends javax.swing.JFrame implements Printable{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Panadería Dulce Pan");
        ...
        lCapital.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lCapital.setText("Capital");

        lDesinversiones.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lDesinversiones.setText("Desinversiones");

        lInversiones.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
